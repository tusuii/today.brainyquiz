"""
Mock tasks module for testing.
This module provides mock versions of Celery tasks for testing.
"""
...
# Mock Celery tasks
@mock_task(name='app.tasks.process_quiz_submission')
def process_quiz_submission(user_quiz_id):
    """
    Mock version of the process_quiz_submission task for testing.
...
@mock_task(name='app.tasks.generate_quiz_statistics')
def generate_quiz_statistics(quiz_id):
    """
    Mock version of the generate_quiz_statistics task for testing.
